...
class Test(unittest.TestCase):
    ...
    def test_earliest_ancestor(self):
        ...
        self.assertEqual(earliest_ancestor(test_ancestors, 8), 4)  # This was 4 (wrong? Supposed to be smallest # in tie)
        self.assertEqual(earliest_ancestor(test_ancestors, 9), 4)  # This was 4 (wrong? Supposed to be smallest # in tie)
