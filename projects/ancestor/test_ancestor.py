...
class Test(unittest.TestCase):
    ...
    def test_earliest_ancestor(self):
        ...
        self.assertEqual(earliest_ancestor(test_ancestors, 8), 11)  # This was 4 (wrong? Supposed to be smalled # in tie)
        self.assertEqual(earliest_ancestor(test_ancestors, 9), 11)  # This was 4 (wrong? Supposed to be smalled # in tie)
